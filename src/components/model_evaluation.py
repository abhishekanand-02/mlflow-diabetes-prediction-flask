...
class ModelEvaluation:
    ...
    def initiate_model_evaluation(self, train_array, test_array):
        ...
        try:
            # Splitting features (X) and target (y) from the test array
            ...
            with mlflow.start_run():
                ...
                if tracking_url_type_store != "file":
                    # Register the model if the tracking store is not a file-based system
                    mlflow.sklearn.log_model(model, "model", registered_model_name="logistic_regression_model")
                else:
